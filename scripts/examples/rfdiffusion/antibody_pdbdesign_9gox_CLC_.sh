...
poetry run python  /home/scripts/rfdiffusion_inference.py \
    ...
    antibody.target_pdb=/home/scripts/examples/rfdiffusion/example_inputs/CCR8.pdb \
    ...
    inference.output_prefix=/home/scripts/examples/rfdiffusion/example_outputs/9gox/ab
