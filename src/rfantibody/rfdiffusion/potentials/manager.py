...
class PotentialManager:
    ...
    def parse_potential_string(self, potstr):
        ...
        for key in setting_dict:
            if key in str_settings:
                ...
                setting_dict[key] = setting_dict[key] == "True"
            else:
    ...
    def initialize_all_potentials(self, setting_list):
        ...
        for potential_dict in setting_list:
            assert potential_dict["type"] in potentials.implemented_potentials, (
            ...
            if self.inference_config.symmetry:
                ...
                print(
                    "WARNING: Hard coded in potentials, number of components = 1 per ASU. Multi-component ASU potentials may not work yet."
                )
                contact_kwargs = {
                    "nchain": num_chains,
    ...
    def compute_all_potentials(self, seq, xyz):
        ...
        potential_list = [
            potential.compute(seq, xyz) for potential in self.potentials_to_apply
        ]
